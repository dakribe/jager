          ...
          <div className="z-10 flex flex-col items-center justify-center">
            <div className="sm:px-20">
              <span className="text-xl font-medium tracking-[-0.16px] text-gray-600 md:text-2xl">
                A Time-Based One-Time Password Authentication, that supports
                Email Verification and Magic Link in your{" "}
                <span className="font-semibold text-black">Remix</span>{" "}
                application.
              </span>
            </div>
          </div>
